...
#Class based view for above products [List view]
...
## Class based view for above productdetail view [DetailView]
...
class PaymentSuccessView(TemplateView):
    ...
    def get(self,request,*args,**kwargs):
        ...
        stripe.api_key = settings.STRIPE_SECRET_KEY
        order = get_object_or_404(OrderDetail,stripe_payment_intent=session.payment_inten)
        order.has_paid = True
        order.save()
